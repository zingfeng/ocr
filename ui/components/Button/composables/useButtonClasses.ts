...
const buttonOutlineColorClasses: ButtonClassMap<
  Exclude<ButtonVariant, 'light' | 'alternative'>
> = {
  default: {
  ...
  const bindClasses = computed(() => {
    ...
    if (isGradient && isOutline) {
      ...
      if (!simpleGradients.includes(props.gradient.value!)) {
        backgroundClass =
          buttonOutlineGradientClasses.default[
            props.gradient
              .value as unknown as keyof typeof buttonOutlineGradientClasses.default
          ];
        ...
        if (!props.disabled.value)
          hoverClass =
            buttonOutlineGradientClasses.hover[
              props.gradient
                .value as unknown as keyof typeof buttonOutlineGradientClasses.hover
            ];
      } else {
        console.warn(
      ...
      if (!alternativeColors.includes(props.color.value)) {
        ...
        backgroundClass =
          buttonOutlineColorClasses.default[
            color as unknown as keyof typeof buttonOutlineColorClasses.default
          ];

        if (!props.disabled.value)
          hoverClass =
            buttonOutlineColorClasses.hover[
              color as unknown as keyof typeof buttonOutlineColorClasses.hover
            ];
      } else {
        console.warn(
      ...
      backgroundClass =
        buttonColorClasses.default[
          color as unknown as keyof typeof buttonColorClasses.default
        ];

      if (!props.disabled.value)
        hoverClass =
          buttonColorClasses.hover[
            color as unknown as keyof typeof buttonColorClasses.hover
          ];
    }
    ...
    if (props.shadow.value === '') {
      ...
      if (
        ...
        shadowClass =
          buttonShadowClasses[
            props.gradient.value as unknown as keyof typeof buttonShadowClasses
          ];
      }
      ...
      if (simpleGradients.includes(props.shadow.value)) {
        shadowClass =
          buttonShadowClasses[
            props.shadow.value as unknown as keyof typeof buttonShadowClasses
          ];
      }
    }
