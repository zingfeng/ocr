...
const flowbiteThemesColors: FlowbiteTheme[] = [
  'blue',
  'green',
  'red',
  'pink',
...
export function useFlowbiteThemable(
  _theme?: FlowbiteTheme,
): UseFlowbiteThemableReturns {
  const theme = inject<Ref<FlowbiteTheme | null>>(
    FLOWBITE_THEMABLE_INJECTION_KEY,
    ref(null),
  );
