<template>
        ...
        >
          <ul class="pb-2 space-y-2">
            ...
            <li>
              <a
                href=""
                class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group dark:text-gray-200 dark:hover:bg-gray-700"
              >
                <svg
            ...
            <li>
              ...
              >
                ...
                >
                <span
                  class="inline-flex justify-center items-center p-1 ml-3 w-5 h-5 text-sm font-medium rounded-full text-primary-800 bg-blue-200 dark:bg-blue-900 dark:text-blue-200"
                  sidebar-toggle-item=""
                  >3</span
                >
                <!-- <span
            ...
            <!-- <li>
            <a href="{{ "calendar" | relURL }}" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group {{ if eq $page_slug "calendar" }} bg-gray-100 {{ end }}">
                <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"></path></svg>
                <span class="flex-1 ml-3 whitespace-nowrap" sidebar-toggle-item>Calendar</span>
            </a>
          </li> -->
            <li>
              <button
              ...
              <ul id="dropdown-ecommerce" class="space-y-2 py-2">
                <li>
                  <a
                    href=""
                    class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700"
                    >Products</a
                  >
                </li>
                <li>
          ...
          <div class="pt-2 space-y-2">
            ...
            <a
              href="https://github.com/themesberg/flowbite/issues"
              target="_blank"
              class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
            >
              <svg
  ...
  <div
    id="sidebarBackdrop"
    class="hidden fixed inset-0 z-10 bg-gray-900/50 dark:bg-gray-900/90"
  ></div>
</template>
